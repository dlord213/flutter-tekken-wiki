            ...
            SliverStickyHeader(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  createInkWellCard(webP: true, fileName: "tekken_revolution", description: "A free-to-play downloadable fighting game on the PlayStation Network, exclusively released for PlayStation 3 in June 2013. It has been praised for bringing back the arcade experience to the console. It also features many similar aspects with role-playing games and social games. Bandai Namco revealed that it and its downloadable content would be removed from the PlayStation Store on January 21st, 2017. The game officially ceased operations on March 20th, 2017."),
