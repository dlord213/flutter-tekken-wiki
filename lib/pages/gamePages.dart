              ...
              slivers: [
                ...
                SliverStickyHeader(
                  ...
                  sliver: SliverList(delegate: SliverChildListDelegate([
                    const ListTile(title: Text("Devil Kazuya"), subtitle: Text("Beat 8 stages in Galaga")),
                    const ListTile(title: Text("Sub-bosses"), subtitle: Text("With any character, beat every character and the sub-boss.")),
                    const ListTile(title: Text("Heihachi"), subtitle: Text("With any character, beat every character up to and including Heihachi without continuing.")),
                    const ListTile(title: Text("Galaga Mini Game Continue Code"), subtitle: Text("After you see the number of ships you've hit on the screen, press the Select button. You should hear a sound indicating it worked. You will now be able to replay that stage.")),
                  ])),
                )
              ],
            );
        ...
        slivers: [
          ...
          SliverStickyHeader(
            ...
            sliver: SliverList(delegate: SliverChildListDelegate([
              ...
              createTextWithImage(
                  imagePath: "tekken_2/1.jpg", heading: "Armor King vs Jack-2"),
              const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text(
          ...
          SliverStickyHeader(
            ...
            sliver: SliverList(delegate: SliverChildListDelegate([
              ...
              const ListTile(title: Text("Fight as Kazuya in purple suit"), subtitle: Text("Highlight Kazuya and press start button.")),
              const ListTile(title: Text("Big Characters"), subtitle: Text("In arcade mode while selecting your character, hold Select and press X.")),
              const ListTile(title: Text("Big Head Mode"), subtitle: Text("Hold the select button while choosing your character, continue holding it until the match begins.")),
              const ListTile(title: Text("Fight as Alex"), subtitle: Text("Highlight Roger and press Square.")),
              const ListTile(title: Text("Sky Mode"), subtitle: Text("	Unlock all characters, then hold Select + Up when choosing a character. Keep holding them until the fight begins.")),
              const ListTile(title: Text("Wireframe mode"), subtitle: Text("Unlock all characters, then hold L2 + L1 while selecting your character. Keep holding them until the match begins.")),
              const ListTile(title: Text("Plump-size character"), subtitle: Text("Press and hold the select button before the 'VS' screen appears. Continue to hold the button until the match begins and your character will turn fat. If you do this trick again, your character will be even fatter in the next match.")),
              const ListTile(title: Text("Angel"), subtitle: Text("Beat the Devil with Kazuya. Press Kick for Angel.")),
              const ListTile(title: Text("Anna"), subtitle: Text("Beat the game with Nina.")),
              const ListTile(title: Text("Armor King"), subtitle: Text("Beat the game with King.")),
              const ListTile(title: Text("Baek"), subtitle: Text("Beat arcade mode with Law.")),
              const ListTile(title: Text("Bruce"), subtitle: Text("Beat Arcade Mode with Lei")),
              const ListTile(title: Text("Devil"), subtitle: Text("Beat the Devil with Kazuya. Press Punch for Devil.")),
              const ListTile(title: Text("Ganryu"), subtitle: Text("Beat the game with Michelle.")),
              const ListTile(title: Text("Kazuya"), subtitle: Text("Beat Devil using any sub-boss and have every sub-boss unlocked.")),
              const ListTile(title: Text("Kuma"), subtitle: Text("Beat arcade mode with Paul.")),
              const ListTile(title: Text("Kunimitsu"), subtitle: Text("Beat arcade mode with Yoshimitsu.")),
              const ListTile(title: Text("Lee"), subtitle: Text("	Beat arcade mode with Heihachi.")),
              const ListTile(title: Text("P. Jack"), subtitle: Text("Beat arcade mode with Jack 2.")),
              const ListTile(title: Text("Roger and Alex"), subtitle: Text("	On stage 3, win the last round with 5% energy or less left.")),
              const ListTile(title: Text("Wang Jinrey"), subtitle: Text("Beat the game with Jun.")),
              const ListTile(title: Text("New Title Screen (Kazuya's Face)"), subtitle: Text("Unlock all Sub Bosses including Alex and Roger")),
              const ListTile(title: Text("Hidden Music Tracks"), subtitle: Text("Put the game disk in a CD Player. The disk will have 3 tracks on it; tracks 1 and 3 are just be really long tracks that don't play anything, but the second is a hidden music track.")),
            ])),
          )
        ],
      ),
            ...
            slivers: [
              ...
              SliverStickyHeader(
                ...
                sliver: SliverList(delegate: SliverChildListDelegate([
                  const Padding(
                    padding: EdgeInsets.all(12.0),
                    child: Text("Tekken 3 maintains the same core fighting system and concept as its predecessors, but brings many improvements, including significantly more detailed graphics and animations, and faster, more fluid gameplay. Fifteen new characters were added to the game's roster"),
                  ),
                  const Padding(
                    padding: EdgeInsets.all(12.0),
                    child: Text("Tekken 3 added a wider variety of sound effects for characters. The music is also significantly different and pushed the limits of the PlayStation's graphical capabilities, and the porting from the arcade was only possible through compression."),
                  ),
                  const Padding(
                    padding: EdgeInsets.all(12.0),
                    child: Text("Tekken 3 added emphasis on the third axis, allowing all characters to sidestep in or out of the background by lightly pressing the arcade stick (or tapping the controller button in the console version) towards the corresponding direction. Another big change in movement was that jumping was toned down, no longer allowing fighters to jump to extreme heights, keeping leaps to reasonable, realistic heights. It made air combat more controllable, and put more use to sidestep dodges, as jumping no longer functioned as a universal dodge move."),
                  ),
                  const Padding(
                    padding: EdgeInsets.all(12.0),
                    child: Text("The improved engine allowed for quick recoveries from knock-downs, more escapes from tackles and stuns, better juggling and extra newly-created combo throws. However, the AI in Tekken 3 was also toned down compared to its predecessors, making fights significantly easier to beat."),
                  )
                ])),
              ),
              SliverStickyHeader(
                ...
                sliver: SliverList(delegate: SliverChildListDelegate([
                  createTextWithImage(imagePath: "tekken_3/ball_1.jpg", heading: "Tekken Ball"),
                  const Padding(
                    padding: EdgeInsets.all(12.0),
                    child: Text("A one-on-one game of beach volleyball in which the player must use kicks and punches to knock the ball to the opponent's side."),
                  ),
                  const Padding(
                    padding: EdgeInsets.all(12.0),
                    child: Text("The mode has three balls to choose from: the Beach Ball is listed as Beginner and does 60% damage; the Gum Ball is listed as Expert and does 80% damage; and the Iron Ball is listed as Grand Master and does 100% damage."),
                  ),
                  createTextWithImage(imagePath: "tekken_3/force_1.jpg", heading: "Tekken Force"),
                  const Padding(
                    padding: EdgeInsets.all(12.0),
                    child: Text("A player takes a character through a side-scrolling mini-game, fighting against the Tekken Force military in four stages. At the end of each stage is a boss character from the playable roster. The boss the player fights against in each stage depends on which character the player chose, with the exception of the fourth stage where the boss is Heihachi Mishima."),
                  )
                ])),
              ),
              SliverStickyHeader(
              ...
              SliverStickyHeader(
                header: createContainerHeader(title: "Unlockables / Secrets"),
                sliver: SliverList(delegate: SliverChildListDelegate([
                  const ListTile(title: Text("Play as Anna"), subtitle: Text("Hightlight Nina and Press Start.")),
                  const ListTile(title: Text("Play as Tiger"), subtitle: Text("Highlight Eddy and press Start.")),
                  const ListTile(title: Text("Choose Victory Animation"), subtitle: Text("After winning a round and you see the replay showing, pressing each button will result in a different victory animation. This also works when the opponent wins.")),
                  const ListTile(title: Text("Different costumes"), subtitle: Text("Highlight either Law, Jin, or Xiang. Select one using the Start button.")),
                  const ListTile(title: Text("Alternate winning pose"), subtitle: Text("After you defeat your opponent, press LK + RK.")),
                  const ListTile(title: Text("Unlock Gon Easily"), subtitle: Text("Get a high score on Survival mode, then enter the following as your name: 'GON'")),
                  const ListTile(title: Text("Alternative End For Gun Jack"), subtitle: Text("Lost the game 10 times with Gun Jack and hold both kicks after every round.")),
                  const ListTile(title: Text("Unlock Gon (Alternative Method)"), subtitle: Text("To unlock Gon, you must beat it in Tekken Ball (it will appear as your first opponent), or in Arcade mode (it appears randomly).")),
                  const ListTile(title: Text("Anna's Zebra Skin costume"), subtitle: Text("Play with Anna 25 times in a row, then select her by pressing Start.")),
                  const ListTile(title: Text("Dr. Bosconovitch"), subtitle: Text("Collect the bronze, silver and gold keys in Tekken Force by completing it three times. Then play through it one more time. After you beat the boss of the last stage, you will be taken to an underground cave and defeat Dr. Bosconovitch.")),
                  const ListTile(title: Text("Jack's Tank Top"), subtitle: Text("Play as Jack 10 times, then select him by pressing Start.")),
                  const ListTile(title: Text("Jin's School Uniform"), subtitle: Text("Play as Jin 50 times, then select him by pressing Start.")),
                  const ListTile(title: Text("Tekken Ball Mode and Gon"), subtitle: Text("Beat the game with all non-hidden game characters.")),
                  const ListTile(title: Text("Theater Mode"), subtitle: Text("Beat the game in arcade mode with all non-hidden characters.")),
                  const ListTile(title: Text("Xiaoyu's School Uniform"), subtitle: Text("Play as Xiaoyu 50 times, then select her by pressing Start.")),
                  const ListTile(title: Text("School Background"), subtitle: Text("First you must have unlocked Jin or Xiaoyu's school uniforms. Once you've done that select a two-player game and choose Jin or Xiaoyu by pressing Triangle before your opponent selects their player. You'll then get to fight in a school yard background.")),
                  const ListTile(title: Text("Unlock Gun Jack's Full Ending"), subtitle: Text("After you unlock Gun Jack's Bad Ending by beating Arcade Mode once. Save your game and beat Arcade Mode a second time to unlock Gun Jack's Good Ending. Go to Theater Mode to view his Full Ending.")),
                  const ListTile(title: Text("Listen to a Song"), subtitle: Text("If you put Tekken 3 into your computer, or a CD player, and go to Track 2, you can listen to a 2:37 song called The King Of Iron Fist Tournament 3: Enter The Tekken.")),
                  const ListTile(title: Text("Make Mokujin Sound as a Wooden Block"), subtitle: Text("On Mokujin's picture, hold down until the match begins.")),
                  const ListTile(title: Text("Tekken and Tekken 2 Videos"), subtitle: Text("While in Theater mode, if you have save data from Tekken or Tekken 2 on your memory card. You can view any unlocked FMVs from either game.")),
                ])),
              )
            ],
          )
          ...
          body: CustomScrollView(
            slivers: [
              ...
              SliverStickyHeader(
                header: createContainerHeader(title: "Unlockables / Secrets"),
                sliver: SliverList(delegate: SliverChildListDelegate([
                  const ListTile(title: Text("Attack All Enemies (Tekken Force Mode)"), subtitle: Text("When using a move combination with King in Tekken Force mode, it will damage all enemies standing close to you as well. Though it makes fights easy, it tends to eat up valuable time.")),
                  const ListTile(title: Text("Display Attack Names during game."), subtitle: Text("In Arcade/Time Attack/Team Battle/VS mode, press Select during the game and you will see the names of your attack moves. Every time you enter a command attack, its Japanese name will be displayed.")),
                  const ListTile(title: Text("Practice Mode Move Percentage"), subtitle: Text("Enter Practice mode and select any character. Then press start and choose the command list. Now press and hold any of the shoulder buttons (R1,R2,L1,L2) and you should see the precentage of how many times you have performed that move in practice mode instead of the button combination for the move.")),
                  const ListTile(title: Text("Unlock Theater Mode"), subtitle: Text("Beat the game once in Story mode.")),
                  const ListTile(title: Text("Choose Victory Animation"), subtitle: Text("After winning a round and you see the replay showing, pressing each button will result in a different victory animation. This also works when the opponent wins.")),
                  const ListTile(title: Text("Alternate Ling Xiaoyu costume"), subtitle: Text("After beating story mode with Ling Xiaoyu highlight her in the character selection screen and press Triangle.")),
                  const ListTile(title: Text("Play as Eddy Gordo"), subtitle: Text("You must first complete story mode once with Christie. On character select screen, highlight Christie and press TRIANGLE.")),
                  const ListTile(title: Text("Play as Miharu"), subtitle: Text("You must first complete story mode once with Xiaoyu. During character select screen, highlight Xiaoyu and press CIRCLE.")),
                  const ListTile(title: Text("Play as Panda"), subtitle: Text("In the character select screen highlight Kuma and press either Triangle or Circle.")),
                  const ListTile(title: Text("Play As Violet"), subtitle: Text("Highlight Lee at the character selection screen and press Circle.")),
                  const ListTile(title: Text("Dojo Stage"), subtitle: Text("Clear Tekken Force mode.")),
                  const ListTile(title: Text("Statue Stage"), subtitle: Text("Complete Story Mode with Steve Fox.")),
                ])),
              )
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: CustomScrollView(
          slivers: [
            returnSliverAppBar(title: "TEKKEN 5", logo: "tekken_5", isWebP: true),
            SliverStickyHeader(
              header: createContainerHeader(title: "Story"),
              sliver: SliverList(delegate: SliverChildListDelegate([
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("The King of Iron Fist Tournament 4 concluded with a face-off between three generations of the Mishima family – Heihachi Mishima, Kazuya Mishima, and Jin Kazama – in Hon-Maru. Jin ultimately defeated his grandfather and father and fled the temple in his devil form."),
                ),
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("Shortly afterwards, just as Heihachi and Kazuya are coming to, numerous Jack-4 robots deployed by G Corporation crash through Hon-Maru's walls and attack. Kazuya and Heihachi begin fighting as a team against the robots. During the battle, Kazuya escapes after betraying Heihachi and throwing him into the path of the robots. While Heihachi is restrained, the robots self-destruct, destroying Hon-Maru. A mysterious character, Raven, watches the scene from a nearby cliff."),
                ),
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("Meanwhile, Jin Kazama's Devil Gene causes him to lose control. He blacks out shortly after fleeing Hon-Maru and wakes up in a destroyed forest. He realizes that his devil form caused the destruction. Jin retreats to Yakushima, but is plagued by nightmares that trigger his Devil Gene. Realizing he cannot go on like this, he sets out to try and destroy the evil at its root."),
                ),
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("The King of Iron Fist Tournament 5 is announced by the Mishima Zaibatsu. With Heihachi Mishima believed dead, it is unclear to the competitors who has called the competition."),
                ),
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("Jin enters the tournament and makes it to the final round, where he is confronted with the monstrous form of his great grandfather, Jinpachi Mishima. Jinpachi was imprisoned beneath Hon-Maru 44 years ago by Heihachi and has been possessed by a malevolent entity."),
                ),
                createTextWithImage(imagePath: "tekken_5/story-1.jpg", heading: "Jin Kazama"),
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("Jinpachi was finally freed from his prison when the Jack-4s destroyed Hon-Maru. Now, the mysterious entity is consuming Jinpachi's mind. Jinpachi announced the tournament with the hope that someone would emerge with the power to kill him and put an end to the entity’s reign of terror before it starts. The entity is implied to have affected Jin’s Devil Gene, triggering the evil that had built up inside him.\n\nJin defeats Jinpachi Mishima, who dissolves into dust and disappears. Now, Jin is the owner of the Mishima Zaibutsu. He assumes the throne and smiles in a sinister way, hinting at events to follow."),
                ),
              ])),
            ),
            SliverStickyHeader(
              ...
              sliver: SliverList(delegate: SliverChildListDelegate([
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("Tekken 5 is credited for taking the series back to its roots. It incorporates a faster, more fluid fighting system, improved graphics, returning characters, and some of the Tekken series' trademark infinite stages. New to Tekken 5 is the Crush System which affects the vulnerability of a character while they attack. For example, a move with jumping properties, such as a hop kick, will be completely invulnerable during most of its animation time to all of an opponent's low attacks."),
                ),
                createTextWithImage(imagePath: "tekken_5/menu.jpg", heading: "Main Menu"),
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("It also retains its wall juggling concept from Tekken 4, but the element is effectively less easy to abuse and easier to defend against. Tekken 5 also introduced a Ranking system for the first time."),
                ),
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("The home version is a collector's edition of sorts, as it includes full arcade emulations of Tekken, Tekken 2, Tekken 3 and StarBlade. Tekken 5 also allowed players to customize their fighter for the first time, allowing them to change the colors of their outfits, buy additional costumes, and equip them with items by using money gained from playing the Story, Survival, Time Attack, the side-story Devil Within, and Arcade Battle modes."),
                ),
                createTextWithImage(imagePath: "tekken_5/costume.webp", heading: "Asuka's Costume"),
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("A number of characters who were absent from Tekken 3 or Tekken 4 returned, such as Anna Williams, Bruce Irvin, Wang Jinrei and others. This, combined with seven newly introduced characters, gave Tekken 5 a roster of 37 characters, almost as many as the 'all-stars' Tekken Tag Tournament game."),
                ),
                createTextWithImage(imagePath: "tekken_5/selection.jpg", heading: "Selection Screen"),
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("Due to the huge imbalance in the original version of the game, most notably concerning the likes of Steve and Kazuya, an arcade-exclusive update was released, known as Tekken 5.1. Aside from attempting to balance the game (ground moves now inflicted 70% damage instead of 100%), 5.1 also changed the health bar from yellow to green."),
                ),
                createTextWithImage(imagePath: "tekken_5/fight-2.jpg", heading: "Fight")
              ])),
            ),
            SliverStickyHeader(
              ...
              sliver: SliverList(delegate: SliverChildListDelegate([
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("The Devil Within mode is a fighting minigame in direct lineage to the Tekken Force modes in Tekken 3 and Tekken 4. This minigame follows Jin Kazama as he searches G Corporation after hearing rumours that his missing mother may be there. Being somewhat story oriented, the player is not permitted to use their own choice of characters like previous iterations."),
                ),
                const Padding(
                  padding: EdgeInsets.all(12.0),
                  child: Text("Along with fighting various Jack models and G Corp minions in the mini-game, the player must pursue minor key quests to proceed. The game has five bosses: Modified Gun Jack, Clone-Heihachi, True Ogre, the Soul Sphere, and Monstrous Ogre. This mode is one of the two ways to unlock the playable version of Devil Jin."),
                ),
                createTextWithImage(imagePath: "tekken_5/devilwithin.jpg", heading: "Gameplay"),
              ])),
            ),
            SliverStickyHeader(
              header: createContainerHeader(title: "Characters"),
            ...
            SliverStickyHeader(
              header: createContainerHeader(title: "Unlockables / Secrets"),
              sliver: SliverList(delegate: SliverChildListDelegate([
                const ListTile(title: Text("Alternate Mokujin sounds"), subtitle: Text("To hear different hit sounds for Mokujin, hold DOWN on the D-Pad or joystick before a match in which you are controlling him. Mokujin will now sound like a block of wood when damaged.")),
                const ListTile(title: Text("Arcade History Dip Switches"), subtitle: Text("While at the Press Start screen for any of the Arcade History games, hold the select button and you will be given a list of dip switches. You can use these for such things as changing number of rounds or unlocking hidden characters, such as Baek in Tekken 2.")),
                const ListTile(title: Text("Choose Victory Animation"), subtitle: Text("After winning a round and you see the replay showing, pressing each button will result in a different victory animation. This also works when the opponent wins.")),
                const ListTile(title: Text("Chooses Female Mokujin"), subtitle: Text("Press X while selecting Mokujin")),
                const ListTile(title: Text("Chooses Panda"), subtitle: Text("Press X while selecting Kuma")),
                const ListTile(title: Text("Easy rank-up in Arcade Mode"), subtitle: Text("When playing arcade mode simply quit the match before you lose the second round and you won't get a demotion or lose any experience.")),
                const ListTile(title: Text("Asuka Black Geisha Costume"), subtitle: Text("Circle button (After purchasing her extra costume for 500,000)")),
                const ListTile(title: Text("Asuka School Uniform"), subtitle: Text("Triangle button (After purchasing her extra costume for 500,000)")),
                const ListTile(title: Text("Jinpachi's Movie"), subtitle: Text("To unlock Jinpachi's movie in Theater mode, you have to lose to him and get a game over using any character in Story Battle mode.")),
                const ListTile(title: Text("Stage Select for Devil Within"), subtitle: Text("Beat Devil Within once to unlock the stage select feature.")),
                const ListTile(title: Text("Star Blade in Arcade History"), subtitle: Text("You have to unlock Star Blade from Devil Within. Go to the first room in Stage 4-2, there is a breakable wall underneath the higher ledge. Transform to Devil Jin and press L1+Square to blast at the wall.\n\nThere will be some tiles appear after the wall is destroyed. Jump over the tiles and move on to the next room. There will be a spaceship from Star Blade in the middle of the room. Collect it and continue to beat Stage 4 to unlock Star Blade.")),
                const ListTile(title: Text("Theater Mode"), subtitle: Text("Finish Story mode once using any character to unlock Theater mode. Movies for each character will be unlock once you finish their story.")),
                const ListTile(title: Text("Final Stage 2"), subtitle: Text("Play 200 matches in arcade mode or beat the Devil Within game.")),
                const ListTile(title: Text("Unlocking Random"), subtitle: Text("When you unlock Heihachi you will also unlock Random for Character selection.")),
                const ListTile(title: Text("Hidden Anna Scene"), subtitle: Text("In the fourth Story Mode match against Lee, lose to him on purpose and you'll see Anna being insulted by him.")),
                const ListTile(title: Text("Hidden Marshall Law scene"), subtitle: Text("While playing with Law in story mode, lose the fight against Paul to get a short scene.")),
                const ListTile(title: Text("Hidden Yoshimitsu Scene"), subtitle: Text("To see this interesting scene featuring Yoshimitsu and Raven start a story mode game and choose Yoshimitsu. When you get to the fourth fight which should be against Raven, loose on purpose. A funny scene between the two combatants should come up.")),
                const ListTile(title: Text("Perform Jin's Secret Win Pose"), subtitle: Text("Jin has a different Win Pose. During replay hold X+O and he will say: The Mishima Bloodline ends here!")),
                const ListTile(title: Text("Play as Schoolgirl Ling"), subtitle: Text("Ling has a fifth costume that can be selected by pressing the 'L1' button.")),
                const ListTile(title: Text("Play only as Devil Jin in Devil Within"), subtitle: Text("After beating all stages at least in Medium difficulty, you can go to New Game or Stage Select and before starting the game, hold Select, L2 and R3 (press down and hold Right Stick) and then start the game. You will play only as Devil Jin without a dropping health bar but your ranged attacks still need you to fill the red bar.")),
                const ListTile(title: Text("Secret Ling winning pose."), subtitle: Text("When dressed in Ling's schoolgirl outfit, win a battle and as soon as it plays the replay hold down Triangle and Square and you will see her secret pose.")),
              ])),
            )
          ],
        ),
        ...
        body: CustomScrollView(
          slivers: [
            ...
            SliverStickyHeader(
              header: createContainerHeader(title: "Unlockables / Secrets"),
              sliver: SliverList(delegate: SliverChildListDelegate([
                const ListTile(title: Text("Selectable Win Poses"), subtitle: Text("Just before the win sequence plays at the end of a match, hold left punch, right punch, left kick or right kick to select your win pose. Some characters may have more or less win poses than others.")),
                const ListTile(title: Text("Comic Effect in English and Japanese"), subtitle: Text("Beat the Last level of Scenario Mode.")),
              ])),
            )
          ],
        ),
